...
class HCAE(Model):
    ...
    def _build(self):
        with tf.compat.v1.variable_scope('Encoder', reuse=tf.compat.v1.AUTO_REUSE):
            ...
            print("output",FLAGS.hidden1)
            self.noise = gaussian_noise_layer(self.hidden1, 0.1)
            print("input2",FLAGS.hidden1)
            print("output2",FLAGS.hidden2)
            ...
            print("output_dim",FLAGS.output_dimension)
